...
// --- Dynamic data loading for products/orders and chart ---
(function () {
    ...
    function renderWeeklyChart(orders) {
        ...
        // Build map for last 7 days (labels Sun..Sat but anchored to last 7 days)
        const days = [];
    ...
    async function init() {
        ...
        // Optionally update stats cards: sales/revenue/orders/customers
        try {
